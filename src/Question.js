...
export default function Question(props) {
    ...
    return (
        <div className="question-container">
            ...
            <button name={props.answers[0].answer} id={props.answers.indexOf(props.answers[0])} className="choice" onClick={(e) => props.handleAnswer(e)} value={props.questionIndex} style={buttonOneStyles}>{props.answers[0].answer}</button>
